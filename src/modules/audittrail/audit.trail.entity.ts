...
export class AuditTrail extends BaseEntity {
  ...
  constructor(
    ...
    this.annotatedClassifierDocumentBlobFilePath =
      annotatedClassifierDocumentBlobFilePath;
    this.annotatedExtractorDocumentBlobFilePath =
      annotatedExtractorDocumentBlobFilePath;
